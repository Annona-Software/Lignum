...
import com.annonasoftware.lignum.fluids.FlaskFluidHandler;
...
public abstract class ItemFlask extends ItemFluidContainer implements IItemSize {
    ...
    public void initModel(Item item, int meta, String id) {
        ModelResourceLocation modelFull = new ModelResourceLocation(Woodworking.MOD_ID + ":" + id , "inventory");
        ModelResourceLocation model4 = new ModelResourceLocation(Woodworking.MOD_ID + ":" + id + "-4", "inventory");
        ModelResourceLocation model3 = new ModelResourceLocation(Woodworking.MOD_ID + ":" + id + "-3", "inventory");
        ModelResourceLocation model2 = new ModelResourceLocation(Woodworking.MOD_ID + ":" + id + "-2", "inventory");
        ModelResourceLocation model1 = new ModelResourceLocation(Woodworking.MOD_ID + ":" + id + "-1", "inventory");
        ModelResourceLocation model0 = new ModelResourceLocation(Woodworking.MOD_ID + ":" + id + "-0", "inventory");
                ...
                if (fluidConsumed != null) {
                    ...
                    if (drinkable != null) {
                        ...
                        if (stack.getItemDamage() == stack.getMaxDamage()) {
                            ...
                            {
                                ItemHandlerHelper.giveItemToPlayer((EntityPlayer) entityLiving, new ItemStack(ItemsWoodworking.brokenLeatherFlask));
                            }
                            else
                            {
                                ItemHandlerHelper.giveItemToPlayer((EntityPlayer) entityLiving, new ItemStack(ItemsWoodworking.brokenIronFlask));
                            }
    ...
    public String getItemStackDisplayName(@Nonnull ItemStack stack)
    {
        ...
        if (bucketCap != null)
        {
            ...
            if (fluidStack != null)
            {
                ...
                return new TextComponentTranslation("item."+ Woodworking.MOD_ID+".filled_"+name+".name", fluidname).getFormattedText();
            }
        }
